...
// 颜色代码定义
const std::string Logger::kColorReset = "\033[0m";
const std::string Logger::kColorDebug = "\033[36m";    // 青色
const std::string Logger::kColorInfo = "\033[32m";     // 绿色
const std::string Logger::kColorWarning = "\033[33m";  // 黄色
const std::string Logger::kColorError = "\033[31m";    // 红色
const std::string Logger::kColorFatal = "\033[35m";    // 紫色
...
std::string Logger::GetLevelColor(LogLevel level) const {
  if (!config_.enable_colors) return "";
  switch (level) {
    case LogLevel::kDebug:
      return kColorDebug;
    case LogLevel::kInfo:
