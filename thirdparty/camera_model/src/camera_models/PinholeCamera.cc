...
double& PinholeCamera::Parameters::k1() { return m_k1; }

double& PinholeCamera::Parameters::k2() { return m_k2; }

double& PinholeCamera::Parameters::p1() { return m_p1; }

double& PinholeCamera::Parameters::p2() { return m_p2; }

double& PinholeCamera::Parameters::fx() { return m_fx; }

double& PinholeCamera::Parameters::fy() { return m_fy; }

double& PinholeCamera::Parameters::cx() { return m_cx; }

double& PinholeCamera::Parameters::cy() { return m_cy; }

double PinholeCamera::Parameters::k1() const { return m_k1; }

double PinholeCamera::Parameters::k2() const { return m_k2; }

double PinholeCamera::Parameters::p1() const { return m_p1; }

double PinholeCamera::Parameters::p2() const { return m_p2; }

double PinholeCamera::Parameters::fx() const { return m_fx; }

double PinholeCamera::Parameters::fy() const { return m_fy; }

double PinholeCamera::Parameters::cx() const { return m_cx; }

double PinholeCamera::Parameters::cy() const { return m_cy; }
...
Camera::ModelType PinholeCamera::modelType() const { return mParameters.modelType(); }

const std::string& PinholeCamera::cameraName() const { return mParameters.cameraName(); }

int PinholeCamera::imageWidth() const { return mParameters.imageWidth(); }

int PinholeCamera::imageHeight() const { return mParameters.imageHeight(); }
...
void PinholeCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p, float image_scalse) const {
...
int PinholeCamera::parameterCount() const { return 8; }

const PinholeCamera::Parameters& PinholeCamera::getParameters() const { return mParameters; }
...
std::string PinholeCamera::parametersToString() const {
